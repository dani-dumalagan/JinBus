...
;; *************** function _main *****************
;; Defined at:
;;		line 77 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
...
psect	maintext,global,class=CODE,delta=2,split=1
	file	"D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
	line	77
global __pmaintext
...
l580:	
;dumalaganDa_LE7-1.c: 78: TRISD = 0xFF;
	movlw	(0FFh)
...
l582:	
;dumalaganDa_LE7-1.c: 79: init_I2C_Master();
	fcall	_init_I2C_Master
	goto	l584
	line	80
;dumalaganDa_LE7-1.c: 80: for(;;) {
	
l65:	
	line	81
	
l584:	
;dumalaganDa_LE7-1.c: 81: I2C_Start();
	fcall	_I2C_Start
	line	82
	
l586:	
;dumalaganDa_LE7-1.c: 82: I2C_Send(0x10);
	movlw	(010h)
	fcall	_I2C_Send
	line	83
	
l588:	
;dumalaganDa_LE7-1.c: 83: I2C_Send(PORTD);
...
l590:	
;dumalaganDa_LE7-1.c: 84: I2C_Stop();
	fcall	_I2C_Stop
	line	85
	
l592:	
;dumalaganDa_LE7-1.c: 85: delay_ms(200);
	movlw	low(0C8h)
...
;; Defined at:
;;		line 22 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l542:	
;dumalaganDa_LE7-1.c: 23: TRISC3 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	bsf	(1083/8)^080h,(1083)&7	;volatile
	line	24
;dumalaganDa_LE7-1.c: 24: TRISC4 = 1;
	bsf	(1084/8)^080h,(1084)&7	;volatile
	line	25
	
l544:	
;dumalaganDa_LE7-1.c: 25: SSPCON = 0x28;
	movlw	(028h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(20)	;volatile
...
l546:	
;dumalaganDa_LE7-1.c: 26: SSPCON2 = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l548:	
;dumalaganDa_LE7-1.c: 28: SSPSTAT = 0x00;
	clrf	(148)^080h	;volatile
	line	29
;dumalaganDa_LE7-1.c: 29: SSPADD = 0x09;
	movlw	(09h)
...
;; *************** function _delay_ms *****************
;; Defined at:
;;		line 15 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
;; Parameters:    Size  Location     Type
...
l530:	
;dumalaganDa_LE7-1.c: 16: unsigned int i,j;
;dumalaganDa_LE7-1.c: 17: for(i=0;i<ms_Count;i++) {
	clrf	(delay_ms@i)
	clrf	(delay_ms@i+1)
	goto	l33
...
l532:	
;dumalaganDa_LE7-1.c: 18: for(j=0;j<1000;j++);
	clrf	(delay_ms@j)
	clrf	(delay_ms@j+1)
...
;; *************** function _I2C_Stop *****************
;; Defined at:
;;		line 44 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l554:	
;dumalaganDa_LE7-1.c: 46: I2C_Wait();
	fcall	_I2C_Wait
	line	48
	
l556:	
;dumalaganDa_LE7-1.c: 48: PEN = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
;; *************** function _I2C_Start *****************
;; Defined at:
;;		line 37 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l550:	
;dumalaganDa_LE7-1.c: 39: I2C_Wait();
	fcall	_I2C_Wait
	line	41
	
l552:	
;dumalaganDa_LE7-1.c: 41: SEN = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
;; *************** function _I2C_Send *****************
;; Defined at:
;;		line 58 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
;; Parameters:    Size  Location     Type
...
l558:	
;dumalaganDa_LE7-1.c: 60: I2C_Wait();
	fcall	_I2C_Wait
	line	62
	
l560:	
;dumalaganDa_LE7-1.c: 62: SSPBUF = data;
...
;; *************** function _I2C_Wait *****************
;; Defined at:
;;		line 32 in file "D:\JinBus\CpE 3201\Practical Activity #7\CpE 3201-LE7-1\dumalaganDa_LE7-1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l524:	
;dumalaganDa_LE7-1.c: 34: while((SSPCON2 & 0x1F) || (SSPSTAT & 0x04));
	goto	l526
